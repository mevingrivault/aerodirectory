    ...
    <div style={{ fontFamily: "var(--f-sans)", color: "var(--ink-950)", background: "var(--paper-50)" }}>
      <main style={{ maxWidth: 1280, margin: "0 auto", padding: "0 48px" }}>
        ...
        <section style={{
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <div style={{
              ...
              <span style={{
                ...
                background: "var(--vfr-500)",
                boxShadow: "0 0 0 3px var(--vfr-100)",
                display: "inline-block",
                animation: "nv-pulse 2.4s ease-in-out infinite",
              }} />
              <span>Conditions VFR sur <span style={{ fontFamily: "var(--f-mono)", fontWeight: 600, fontSize: 11, color: "var(--ink-950)" }}>LFLI</span> · Vent <span style={{ fontFamily: "var(--f-mono)", fontWeight: 600, fontSize: 11, color: "var(--ink-950)" }}>30° 13kt</span> · QNH <span style={{ fontFamily: "var(--f-mono)", fontWeight: 600, fontSize: 11, color: "var(--ink-950)" }}>1022</span></span>
            </div>
            ...
            <div style={{
              ...
              {[
                { val: stats.total.toString(), unit: "+", label: "aérodromes référencés" },
                { val: stats.ulmAndSeaplane.toString(), unit: "+", label: "bases ULM & hydrosurfaces" },
          ...
          <div aria-hidden="true" style={{
            ...
            <div style={{
              position: "absolute", inset: 0,
              background: "linear-gradient(180deg, oklch(0.97 0.01 95) 0%, oklch(0.94 0.015 95) 100%)",
            }} />
            <svg style={{ position: "absolute", inset: 0, width: "100%", height: "100%" }} viewBox="0 0 500 600" xmlns="http://www.w3.org/2000/svg">
              ...
              <text x="150" y="165" fontFamily="JetBrains Mono" fontSize="9" fill="oklch(0.45 0.15 280)" opacity="0.75" letterSpacing="1">CTR LFLI · SFC-2500</text>
              ...
              <g fill="oklch(0.55 0.08 40)" opacity="0.7">
                ...
                <rect x="115" y="208" width="4" height="4"/>
                <rect x="123" y="210" width="5" height="5"/>
              </g>
              ...
              <g fill="oklch(0.55 0.08 40)" opacity="0.7">
                ...
                <rect x="383" y="448" width="4" height="4"/>
              </g>
              <text x="378" y="465" fontFamily="Inter" fontSize="9" fontWeight="600" fill="oklch(0.35 0.05 40)">MÉREAU</text>
            </svg>

            <div style={{
              position: "absolute", top: 16, left: 16, right: 16,
              display: "flex", justifyContent: "space-between",
              fontFamily: "var(--f-mono)", fontSize: 10, color: "var(--ink-500)",
            ...
            <div style={{
              ...
              background: "white", border: "2px solid var(--horizon-700)",
              display: "grid", placeItems: "center",
              color: "var(--horizon-700)", boxShadow: "var(--shadow-pop)",
              transform: "translate(-50%,-50%)",
            }}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M17.8 19.2 16 11l3.5-3.5c.6-.6.8-1.4.6-2.1-.3-.8-1-1.3-1.8-1.5-.8-.1-1.6.1-2.1.6L12.7 8 4 6.4 2.4 8 9 12l-3 3H2l2 3 3 2 3-4v-4l4 6.6 1.8-1.4Z"/></svg>
            </div>
            <div style={{
              position: "absolute", top: "76%", left: "12%",
              width: 18, height: 18, borderRadius: "50%",
              background: "white", border: "1.5px solid var(--horizon-700)",
              display: "grid", placeItems: "center",
              color: "var(--horizon-700)", boxShadow: "var(--shadow-pop)",
              transform: "translate(-50%,-50%)",
            }}>
            ...
            <div style={{
              position: "absolute", top: "20%", left: "88%",
              width: 18, height: 18, borderRadius: "50%",
              background: "white", border: "1.5px solid var(--horizon-700)",
              display: "grid", placeItems: "center",
              color: "var(--horizon-700)", boxShadow: "var(--shadow-pop)",
            ...
            <div style={{
              ...
              padding: "6px 10px",
              background: "white", border: "1px solid var(--ink-200)", borderRadius: 6,
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                ...
                <span style={{
                  ...
                  background: "var(--vfr-100)", color: "var(--vfr-700)",
                }}>
                  <span style={{ width: 6, height: 6, borderRadius: "50%", background: "var(--vfr-500)", display: "inline-block" }} />
                  VFR
                </span>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)" }}>
                {[
                  ...
                  <div key={s.label} style={{
                    padding: "0 14px",
                    borderRight: i < 3 ? "1px solid var(--ink-200)" : "none",
                    ...(i === 0 ? { paddingLeft: 0 } : {}),
                    ...(i === 3 ? { paddingRight: 0 } : {}),
        ...
        <section style={{ padding: "40px 0 96px" }}>
          <div style={{ marginBottom: 56 }}>
            <div style={{
              ...
              fontFamily: "var(--f-mono)", fontSize: 11, textTransform: "uppercase", letterSpacing: "0.16em",
            ...
            }}>Quatre instruments<br/>pour une escapade réussie.</h2>
        ...
        <section style={{ padding: "24px 0 96px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "0.9fr 1.1fr", gap: 80, alignItems: "center" }}>
            ...
            <div style={{
              ...
              {[
                {
                  name: "Romorantin Pruniers", oaci: "LFYR",
                  meta: "289 ft · piste 1100 m", dept: "Loir-et-Cher",
                  amens: ["Restaurant club-house", "Ouvert 7/7", "Vélos en prêt", "100LL"],
                  mt: 28,
                },
                {
                  name: "Vierzon Méreau", oaci: "LFLI",
                  meta: "407 ft · piste 800 m", dept: "Cher",
                  amens: ["Hébergement 2 km", "Restaurant sur site", "Taxi sur appel"],
                  mt: 0,
                },
                {
                  name: "Thouars", oaci: "LFCT",
                  meta: "341 ft · piste 700 m", dept: "Deux-Sèvres",
                  amens: ["Brasserie au bourg", "Château 15 min à pied"],
                  mt: 0,
                },
              ].map((ad) => (
                <div key={ad.oaci} style={{
                  ...
                  <div style={{ fontSize: 12, color: "var(--ink-500)" }}>
                    <span style={{ fontFamily: "var(--f-mono)" }}>{ad.meta}</span> · {ad.dept}
                  </div>
            ...
            <div>
              ...
              <h2 style={{
                ...
                margin: "0 0 20px", maxWidth: 720,
              }}>Pas seulement un<br/>terrain d&apos;atterrissage.</h2>
              <p style={{ fontSize: 17, color: "var(--ink-700)", maxWidth: 620, margin: "0 0 40px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
                {[
                  {
                    title: "Restaurants & club-houses",
                    desc: "Les adresses qui ouvrent le dimanche, le menu du jour, la terrasse qui donne sur la piste.",
                    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M3 11V4a1 1 0 0 1 2 0v7"/><path d="M7 11V4a1 1 0 0 1 2 0v7"/><path d="M11 4v11c0 1 1 2 2 2h1v6"/><path d="M16 14c0-6 3-10 5-10v17"/></svg>,
                  },
                  {
                    title: "Hébergements à portée de pied",
                    desc: "Chambres d'hôtes, gîtes et hôtels dans un rayon marchable depuis le parking avions.",
                    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M4 20h16"/><path d="M4 20V10l8-6 8 6v10"/><path d="M9 20v-6h6v6"/></svg>,
                  },
                  {
                    title: "Transport & dernière mile",
                    desc: "Taxi, bus, location de vélo, navette club — pour rejoindre le bourg sans louer une voiture à 80 km.",
                    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M3 12h4l2-3h6l2 3h4"/><rect x="3" y="12" width="18" height="7" rx="1"/></svg>,
                  },
                  {
                    title: "Carburant & services avion",
                    desc: "100LL, SP98, mogas, PPR, parking nuit : tout ce qu'il faut savoir avant de décoller.",
                    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M5 6h14v12H5z"/><path d="M9 6V4h6v2"/><path d="M9 12h6"/></svg>,
                  },
                ].map((f, i, arr) => (
                  <div key={f.title} style={{
                    display: "flex", gap: 16, padding: "20px 0",
                    borderBottom: i < arr.length - 1 ? "1px solid var(--ink-200)" : "none",
                  }}>
                    <div style={{
        ...
        <section style={{ padding: "24px 0 96px" }}>
          <div style={{
            ...
            borderRadius: 20, padding: "56px 56px 0",
            overflow: "hidden", position: "relative",
          }}>
            <div style={{
              position: "absolute", inset: 0,
              background: "radial-gradient(ellipse 50% 40% at 85% 20%, oklch(0.40 0.14 250 / 0.35), transparent 70%), radial-gradient(ellipse 40% 30% at 15% 80%, oklch(0.45 0.08 130 / 0.25), transparent 70%)",
              pointerEvents: "none",
            }} />
            <div style={{ position: "relative", display: "grid", gridTemplateColumns: "1fr 1.15fr", gap: 64, alignItems: "end" }}>
              <div>
                <div style={{
                  display: "flex", alignItems: "center", gap: 14,
                  fontFamily: "var(--f-mono)", fontSize: 11, textTransform: "uppercase", letterSpacing: "0.16em",
                  color: "oklch(0.80 0.02 250)", marginBottom: 20,
                }}>
                  <span style={{ width: 32, height: 1, background: "oklch(0.45 0.02 250)", display: "inline-block" }} />
                  Aérodex · le pokédex aéro
                </div>
                <h2 style={{
                  fontFamily: "var(--f-serif)", fontWeight: 500,
                  fontSize: 44, lineHeight: 1.05, letterSpacing: "-0.02em",
                ...
                <Link href="/register" style={{
                  ...
                  borderRadius: 8, marginBottom: 56,
                  textDecoration: "none",
                }}>
              ...
              <div style={{ paddingBottom: 0, alignSelf: "stretch", display: "flex", flexDirection: "column", gap: 12 }}>
                {[
                  { on: true, name: "Premier vol", desc: "Votre tout premier aérodrome posé", prog: 100, count: "1 / 1",
                    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"/></svg> },
                  { on: false, name: "Pilote du week-end", desc: "Visiter 5 aérodromes différents", prog: 60, count: "3 / 5",
                    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"/></svg> },
                  { on: false, name: "Explorateur", desc: "Poser dans 3 régions différentes", prog: 33, count: "1 / 3",
                    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg> },
                  { on: false, name: "Légende", desc: "Visiter 100 aérodromes", prog: 3, count: "3 / 100",
                  ...
                  <div key={m.name} style={{
                    ...
                    padding: "16px 18px",
                    background: m.on
                      ? "linear-gradient(180deg, oklch(0.32 0.06 130) 0%, oklch(0.24 0.04 130) 100%)"
                      : "oklch(0.24 0.02 250)",
                    border: m.on ? "1px solid var(--terrain-500)" : "1px solid oklch(0.32 0.02 250)",
                    borderRadius: 12,
                  }}>
                    <div style={{
                      width: 44, height: 44, borderRadius: "50%",
                      background: m.on ? "var(--terrain-500)" : "oklch(0.30 0.02 250)",
                      border: m.on ? "1px solid var(--terrain-500)" : "1px solid oklch(0.40 0.02 250)",
                      display: "grid", placeItems: "center",
                      color: m.on ? "var(--ink-950)" : "oklch(0.70 0.02 250)",
                      flexShrink: 0,
                    }}>{m.icon}</div>
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ height: 3, width: 180, background: "oklch(0.32 0.02 250)", borderRadius: 2, marginTop: 8, overflow: "hidden" }}>
                        <span style={{ display: "block", height: "100%", background: "var(--terrain-500)", width: `${m.prog}%` }} />
                      </div>
                    </div>
                    <span style={{ fontFamily: "var(--f-mono)", fontSize: 13, fontWeight: 500, color: "oklch(0.85 0.015 250)" }}>{m.count}</span>
                  </div>
                ))}
                <div style={{ height: 56 }} />
              </div>
        ...
        <section style={{ padding: "24px 0 96px" }}>
          <div style={{ marginBottom: 56 }}>
            ...
            <h2 style={{
              ...
              fontSize: 48, lineHeight: 1.05, letterSpacing: "-0.02em",
              margin: "0 0 20px", maxWidth: 720,
            }}>Un carnet qui grandit<br/>avec la communauté.</h2>
            <p style={{ fontSize: 17, color: "var(--ink-700)", maxWidth: 620, margin: 0 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32 }}>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <span style={{
                  display: "inline-flex", alignItems: "center", gap: 6,
                  padding: "4px 10px",
                  border: "1px solid var(--terrain-500)", background: "var(--terrain-100)",
                  color: "var(--terrain-800)", borderRadius: 999,
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ display: "flex", gap: 8, alignItems: "baseline", marginBottom: 4 }}>
                    ...
                    <span style={{ display: "inline-flex", gap: 1, color: "var(--terrain-500)" }}>
                      {[...Array(4)].map((_, i) => (
                        <svg key={i} width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="m12 2 3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
                      ))}
                    ...
                    <span style={{ fontSize: 11, color: "var(--ink-500)", fontFamily: "var(--f-mono)" }}>LFLI · il y a 3 jours</span>
                  </div>
            ...
            {/* Contributions card */}
            <div style={{
              padding: 40, background: "var(--paper-100)",
              border: "1px solid var(--ink-200)", borderRadius: 20,
              display: "flex", flexDirection: "column", gap: 24,
              backgroundImage: "repeating-linear-gradient(45deg, transparent, transparent 9px, oklch(0.92 0.02 85) 9px, oklch(0.92 0.02 85) 10px)",
            }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <span style={{
                  display: "inline-flex", alignItems: "center", gap: 6,
              ...
              <div style={{
                ...
                padding: "14px 16px", display: "flex", alignItems: "center", gap: 12, marginTop: "auto",
              }}>
                <div style={{
                  width: 36, height: 36, borderRadius: "50%",
                  background: "var(--terrain-800)", color: "white",
                  display: "grid", placeItems: "center",
                  fontSize: 12, fontWeight: 600, flexShrink: 0,
                }}>MG</div>
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: 13, fontWeight: 500, color: "var(--ink-950)" }}>
                    Mévin a ajouté une photo sur <span style={{ fontFamily: "var(--f-mono)", fontSize: 12 }}>LFCT Thouars</span>
                  </div>
                ...
                <span style={{
                  ...
                  color: "var(--ink-700)", borderRadius: 999,
                  fontSize: 11, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.1em",
                }}>+1</span>
              </div>
            </div>
        ...
        <section style={{ padding: "24px 0 96px" }}>
          <div style={{
            padding: "80px 56px",
            borderRadius: 20,
            background: "linear-gradient(135deg, var(--paper-50) 0%, var(--horizon-50) 100%)",
            border: "1px solid var(--ink-200)",
            textAlign: "center",
            ...
            <div style={{ display: "inline-flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
              ...
              <Link href="/search" style={{
                ...
                borderRadius: 8, fontSize: 15, fontWeight: 500,
                background: "white", color: "var(--ink-950)",
                border: "1px solid var(--ink-300)", textDecoration: "none",
              }}>
      ...
      <style>{`
        ...
        @media (max-width: 1080px) {
          .nv-hero { gap: 48px !important; padding: 64px 0 72px !important; }
          .nv-hero-title { font-size: 64px !important; }
          .nv-main { padding: 0 32px !important; }
        }
        @media (max-width: 860px) {
          .nv-main { padding: 0 24px !important; }
          .nv-hero { grid-template-columns: 1fr !important; gap: 40px !important; padding: 40px 0 56px !important; }
          .nv-hero-title { font-size: 56px !important; }
          .nv-caps { grid-template-columns: repeat(2, 1fr) !important; }
          .nv-escapade { grid-template-columns: 1fr !important; gap: 48px !important; }
          .nv-dex-inner { grid-template-columns: 1fr !important; gap: 32px !important; }
          .nv-community { grid-template-columns: 1fr !important; gap: 20px !important; }
        }
        @media (max-width: 640px) {
          .nv-main { padding: 0 20px !important; }
          .nv-hero-title { font-size: 44px !important; }
          .nv-caps { grid-template-columns: 1fr !important; }
        }
      `}</style>
    </div>
  );
